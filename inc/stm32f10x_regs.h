...
#define AFIO_MAPR_SWJ_CFG_SWDP         (2u<<24)
...
#define TIM_CR2_MMS_RESET    (0u<<4)
#define TIM_CR2_MMS_ENABLE   (1u<<4)
#define TIM_CR2_MMS_UPDATE   (2u<<4)
#define TIM_CR2_MMS_CC1IF    (3u<<4)
#define TIM_CR2_MMS_OC1REF   (4u<<4)
#define TIM_CR2_MMS_OC2REF   (5u<<4)
#define TIM_CR2_MMS_OC3REF   (6u<<4)
#define TIM_CR2_MMS_OC4REF   (7u<<4)
#define TIM_CR2_CCDS         (1u<<3)

#define TIM_SMCR_TS_ITR0     (0u<<4)
#define TIM_SMCR_TS_ITR1     (1u<<4)
#define TIM_SMCR_TS_ITR2     (2u<<4)
#define TIM_SMCR_TS_ITR3     (3u<<4)
#define TIM_SMCR_TS_TI1F_ED  (4u<<4)
#define TIM_SMCR_TS_TI1FP1   (5u<<4)
#define TIM_SMCR_TS_TI2FP2   (6u<<4)
#define TIM_SMCR_TS_ETRF     (7u<<4)
#define TIM_SMCR_SMS_DIS     (0u<<0)
#define TIM_SMCR_SMS_ENC1    (1u<<0)
#define TIM_SMCR_SMS_ENC2    (2u<<0)
#define TIM_SMCR_SMS_ENC3    (3u<<0)
#define TIM_SMCR_SMS_RESET   (4u<<0)
#define TIM_SMCR_SMS_GATED   (5u<<0)
#define TIM_SMCR_SMS_TRIGGER (6u<<0)
#define TIM_SMCR_SMS_ECLOCK  (7u<<0)
